        ...
        <div class="table100-head">
            <table>
                ...
                <tr class="row100 head">
                    ...
                    <th class="cell100 column4">Academic Year</th>
                ...
                @if($subjects)
                    @foreach($subjects as $subject)
                        ...
                        <tr class="row100 body">
                            <td class="cell100 column1"><a class="my-subject-teacher-name" href="{{route('teacher.subject.student-record',['subject_id'=>$subject->id])}}">{{$subject->subject->subjectName}}</a></td>
                            <td class="cell100 column2">{{$subject->department->deptName}}</td>
                            <td class="cell100 column3">{{$subject->schedule}}</td>
                            <td class="cell100 column4">{{$subject->year}}</td>
                            @if($subject->active ==1 )
                            <td class="cell100 column5" style="background: green;text-align: center;font-weight: bold;border-radius: 15px" >Active</td>
                            @else
                                <td class="cell100 column5"  style="background: red;text-align: center;font-weight: bold;border-radius: 15px">Not Active</td>
                            @endif
                        </tr>
