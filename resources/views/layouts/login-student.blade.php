...
<html lang="en">
<head>
    <title>Saint Anne Academy | Student</title>
    <meta charset="UTF-8">
...
<div class="limiter">
    <div class="container-login100" style="background-image: url('{{URL::to('assets/img/logo/background.jpg')}}');">
        <div class="wrap-login100">
            ...
            <form class="login100-form validate-form" role="form" method="POST" action="{{ route('student.login.submit') }}">
                {{ csrf_field() }}
                ...
                <input  type="text" placeholder="User Name" class="input100" name="username" value="{{ old('username') }}" required autofocus>
